...
import com.bonss.system.domain.SysUserRole;
import com.bonss.system.service.ISysAdminService;
import com.bonss.system.service.ISysRoleService;
import com.bonss.system.service.impl.SysPermissionService;
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        if (roleService.updateRole(role) > 0)
        {
            ...
            {
                loginUser.setUser(adminService.selectUserByUserName(loginUser.getUser().getUserName()));
    ...
    public TableDataInfo allocatedList(SysAdmin user)
    {
        startPage();
        List<SysAdmin> list = adminService.selectAllocatedList(user);
        return getDataTable(list);
    }
    ...
    public TableDataInfo unallocatedList(SysAdmin user)
    {
        startPage();
        List<SysAdmin> list = adminService.selectUnallocatedList(user);
        return getDataTable(list);
    }

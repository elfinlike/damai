...
public class SysRegisterService
{
    ...
    public String register(RegisterBody registerBody)
    {
        ...
        else if (!adminService.checkUserNameUnique(sysUser))
        {
        ...
        else
        {
            ...
            boolean regFlag = adminService.registerUser(sysUser);
            if (!regFlag)
            {
                msg = "注册失败,请联系系统管理人员";
            }
            ...
            {
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.REGISTER, "用户注册成功"));
            }
        }
        return msg;
    }

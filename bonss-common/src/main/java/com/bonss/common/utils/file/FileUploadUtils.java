package com.bonss.common.utils.file;
...
import com.bonss.common.exception.file.FileNameLengthLimitExceededException;
import com.bonss.common.exception.file.FileSizeLimitExceededException;
import com.bonss.common.exception.file.InvalidExtensionException;
...
import com.bonss.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = BonssConfig.getProfile();
    ...
    {
        // 获取配置文件路径长度
        int dirLastIndex = BonssConfig.getProfile().length();

        // 从 uploadDir 中去除配置路径前缀部分
        String currentDir = uploadDir.substring(dirLastIndex);  // 截取相对路径部分

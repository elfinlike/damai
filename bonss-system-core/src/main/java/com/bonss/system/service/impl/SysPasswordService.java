...
import com.bonss.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class SysPasswordService
{
    ...
    public void validate(SysAdmin user)
    {
    ...
    public boolean matches(SysAdmin user, String rawPassword)
    {
